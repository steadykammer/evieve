        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "v8 evi.helpstarter.js evi.ladder.poles~ 1 1 0 1 1 ladder",
                    "textfile": {
                                        ...
                                        "boxes": [
                                            {
                                                "box": {
                                                    ...
                                                    "numoutlets": 1,
                                                    "outlettype": [ "" ],
                                                    "patching_rect": [ 392.0, 14.0, 28.0, 22.0 ],
                                                    "text": "in 3"
                                                }
                                            },
                                            {
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "numoutlets": 1,
                                                    "outlettype": [ "" ],
                                                    "patching_rect": [ 176.0, 149.0, 99.0, 22.0 ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 0,
                                    "patching_rect": [ 10.0, 70.0, 660.0, 22.0 ],
                                    "text": "The evi.ladder.poles~ algorithm can also be used inside GenExpr code",
                                    "varname": "digest_comment"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "text": "gen~ @title using_evi.ladder.poles~_with_GenExpr",
