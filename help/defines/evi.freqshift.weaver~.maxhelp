        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "v8 evi.helpstarter.js evi.freqshift.weaver~ 1 1 0 1 1 none",
                    "textfile": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 533.0, 373.0, 137.0, 21.0 ],
                                    "text": "algorithm"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "" ],
                                    "parameter_enable": 1,
                                    "patching_rect": [ 437.0, 305.0, 18.0, 50.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 437.0, 372.0, 94.0, 23.0 ],
                                    "text": "prepend select"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 270.0, 371.0, 123.0, 25.0 ],
                                    "text": "Freq Shift ± Hz",
                                    "textjustification": 1
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "signal" ],
                                    "patching_rect": [ 140.0, 372.0, 74.0, 23.0 ],
                                    "text": "cycle~ 110."
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "", "bang" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 218.0, 372.0, 50.0, 23.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 437.0, 512.0, 301.0, 130.0 ]
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 2,
                                    "numoutlets": 0,
                                    "patching_rect": [ 305.0, 512.0, 130.0, 130.0 ]
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 140.0, 427.0, 253.0, 23.0 ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 0,
                                    "patching_rect": [ 10.0, 70.0, 660.0, 22.0 ],
                                    "text": "The evi.freqshift.weaver~ algorithm can also be used inside GenExpr code",
                                    "varname": "digest_comment"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 223.0, 336.0, 447.0, 23.0 ],
                                    "text": "gen~ @title using_evi.freqshift.weaver~_with_GenExpr",
