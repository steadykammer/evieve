                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "", "", "int" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 386.0, 313.0, 20.0, 20.0 ],
                                    "rounded": 60.0,
                                    "saved_attribute_attributes": {
                                        "bgcolor": {
                                            "expression": "themecolor.lesson_step_circle"
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 241.0, 269.0, 187.0, 40.0 ],
                                    "text": "Select Oscillator Shape Here",
                                    "textjustification": 1
                                }
                            },
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 223.0, 286.0, 99.0, 23.0 ],
                                    "text": "prepend hidden"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "int" ],
                                    "patching_rect": [ 223.0, 261.0, 31.0, 23.0 ],
                                    "text": "!= 7"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "int", "", "" ],
                                    "parameter_enable": 1,
                                    "patching_rect": [ 284.0, 311.0, 100.0, 23.0 ],
                                    "saved_attribute_attributes": {
                                        "valueof": {
                                            "parameter_enum": [ "0=saw+", "1=saw-", "2=sawsine+", "3=sawsine+", "4=pulse", "5=hpsaw", "6=logit", "7=trisaw" ],
                                            "parameter_initial": [ 0.0 ],
