                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "", "", "int" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 388.0, 313.0, 20.0, 20.0 ],
                                    "rounded": 60.0,
                                    "saved_attribute_attributes": {
                                        "bgcolor": {
                                            "expression": "themecolor.lesson_step_circle"
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 242.0, 269.0, 187.0, 40.0 ],
                                    "text": "Select Oscillator Shape Here",
                                    "textjustification": 1
                                }
                            },
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "int", "", "" ],
                                    "parameter_enable": 1,
                                    "patching_rect": [ 284.0, 311.0, 102.0, 23.0 ],
                                    "saved_attribute_attributes": {
                                        "valueof": {
                                            "parameter_enum": [ "0=tri", "1=trisaw", "2=pulse", "3=trapezoid", "4=square2", "5=square3" ],
                                            "parameter_initial": [ 0.0 ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 140.0, 336.0, 106.0, 23.0 ],
                                    "text": "mc.evi.tri.select~",
