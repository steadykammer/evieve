        ...
        "boxes": [
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "evi.overdrive.tanh~ @smooth 33"
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "id": "obj-2",
                                    "ignoreclick": 1,
                                    "jsarguments": [ "evi.overdrive.tanh~", 660 ],
                                    "maxclass": "v8ui",
                                    "numinlets": 1,
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "evi.overdrive.tanh~ @lowcutoff 400. @highcutoff 2000.",
                                    "varname": "evieveObject[1]"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "text": "evi.overdrive.tanh~ includes additional gain shaping and filtering options for refining the tonal characteristics of the object. Two filters act like a crossover, summing some dry signal back into the saturated path and controlling how much input signal reaches the saturator.",
                                    "varname": "digest_comment"
                                }
                            },
                            {
            ...
            },
            {
                "box": {
                    ...
                    "text": "v8 evi.helpstarter.js evi.overdrive.tanh~ 1 1 0 1 1 overdrive",
                    "textfile": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "id": "obj-2",
                                    "ignoreclick": 1,
                                    "jsarguments": [ "evi.overdrive.tanh~", "pants:/Users/stkr/Dev/evieve/help/defines/evi.overdrive.tanh~.maxhelp" ],
                                    "maxclass": "v8ui",
                                    "numinlets": 1,
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
            ...
            },
            {
                "box": {
                    ...
                    "id": "obj-6",
                    "ignoreclick": 1,
                    "jsarguments": [ "evi.overdrive.tanh~" ],
                    "maxclass": "v8ui",
                    "numinlets": 1,
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "id": "obj-2",
                                    "ignoreclick": 1,
                                    "jsarguments": [ "mc.evi.overdrive.tanh~", 660 ],
                                    "maxclass": "v8ui",
                                    "numinlets": 1,
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 0,
                                    "patching_rect": [ 10.0, 70.0, 660.0, 22.0 ],
                                    "text": "evi.overdrive.tanh~ is also available as an 'mc' Object",
                                    "varname": "digest_comment"
                                }
                            },
                            {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 0,
                                    "patching_rect": [ 10.0, 70.0, 660.0, 22.0 ],
                                    "text": "The evi.overdrive.tanh~ algorithm is also available inside the gen~ environment",
                                    "varname": "digest_comment"
                                }
                            },
                            {
                                "box": {
                                        ...
                                        "boxes": [
                                            ...
                                            },
                                            {
                                                "box": {
                                                    ...
                                                    "text": "evi_overdrive_tanh @smooth 0"
                                                }
                                            },
                                            {
                                                "box": {
                                    ...
                                    "text": "gen~ @title using_evi.overdrive.tanh~_inside_gen~",
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 0,
                                    "patching_rect": [ 10.0, 70.0, 660.0, 22.0 ],
                                    "text": "The evi.overdrive.tanh~ algorithm can also be used inside GenExpr code",
                                    "varname": "digest_comment"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "text": "gen~ @title using_evi.overdrive.tanh~_with_GenExpr",
