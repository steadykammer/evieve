        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "v8 evi.helpstarter.js evi.paf~ 1 1 0 1 1 oscillator",
                    "textfile": {
                        ...
                        "boxes": [
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 0,
                                    "patching_rect": [ 10.0, 70.0, 660.0, 22.0 ],
                                    "text": "The evi.paf~ algorithm can also be used inside GenExpr code",
                                    "varname": "digest_comment"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 223.0, 336.0, 447.0, 23.0 ],
                                    "text": "gen~ @title using_evi.paf~_with_GenExpr",
