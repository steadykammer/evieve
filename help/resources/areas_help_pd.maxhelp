        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "offset": [ 0.0, 0.0 ],
                    "patching_rect": [ 360.0, 479.0, 192.0, 23.0 ],
                    "viewvisibility": 1
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 87.0, 296.0, 104.0, 21.0 ],
                    "text": "See Also"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 435.0, 40.0, 52.0, 21.0 ],
                    "text": "gen~",
                    "textjustification": 1
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 87.0, 132.0, 73.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 87.0, 215.0, 73.0, 20.0 ],
                    "saved_attribute_attributes": {
                        "textcolor": {
                            "expression": "themecolor.theme_textcolor"
                        }
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 172.0, 132.0, 139.0, 21.0 ],
                    "saved_attribute_attributes": {
                        "textcolor": {
                            "expression": "themecolor.theme_textcolor"
                        }
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 295.0, 594.0, 203.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 297.0, 343.0, 169.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 87.0, 343.0, 169.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 356.0, 672.0, 51.0, 22.0 ],
                    "text": "pcontrol"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 356.0, 633.0, 79.0, 22.0 ],
                    "text": "prepend load"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 133.0, 395.0, 169.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "", "int" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 356.0, 395.0, 169.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 0,
                    "orientation": 0,
                    "patching_rect": [ 438.0, 73.0, 46.0, 101.0 ]
                }
            },
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 77.0, 98.0, 111.0, 20.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 79.0, 142.0, 51.0, 22.0 ],
                                    "text": "evi_bp"
                                }
                            },
                            {
                    ...
                    "patching_rect": [ 356.0, 191.0, 199.0, 22.0 ],
                    "text": "gen~ @t evieve_Pd_filters_in_gen~"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 172.0, 108.0, 110.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 87.0, 108.0, 51.0, 22.0 ],
                    "text": "evi.bp~"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 168.0, 85.0, 118.0, 21.0 ],
