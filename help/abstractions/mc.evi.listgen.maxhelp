        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "text": "v8 evi.helpstarter mc.evi.listgen 2 0 0 0 0 none",
                    "textfile": {
                    ...
                    "patcher": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 10.0, 639.0, 150.0, 21.0 ],
                                    "text": "Thanks to Todd Ingalls"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 217.0, 258.0, 89.0, 40.0 ],
                                    "text": "move slider",
                                    "textjustification": 1
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 269.0, 331.0, 150.0, 40.0 ],
                                    "text": "arbitrary mcwrapper message goes here",
                                    "textjustification": 1
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "", "bang" ],
                                    "parameter_enable": 1,
                                    "patching_rect": [ 475.0, 331.0, 50.0, 23.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 475.0, 363.0, 95.0, 23.0 ],
                                    "text": "prepend chans"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "", "bang" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 170.0, 331.0, 50.0, 23.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 170.0, 300.0, 182.0, 19.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 170.0, 363.0, 97.0, 23.0 ],
                                    "text": "deviate $1 100."
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 170.0, 496.0, 400.0, 23.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "id": "obj-2",
                                    "ignoreclick": 1,
                                    "jsarguments": [ "mc.evi.listgen", "pants:/Users/stkr/Dev/evieve/help/abstractions/mc.evi.listgen.maxhelp" ],
                                    "maxclass": "v8ui",
                                    "numinlets": 1,
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 170.0, 411.0, 157.0, 23.0 ],
                                    "text": "mc.evi.listgen @chans 32",
                        ...
                        "lines": [
                            ...
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-5", 0 ],
                                    "midpoints": [ 484.5, 398.5, 179.5, 398.5 ],
                                    "source": [ "obj-15", 0 ]
                                }
                            },
                            {
                            ...
                            },
                            {
                                "patchline": {
                                    "destination": [ "obj-9", 1 ],
                                    "midpoints": [ 179.5, 465.0, 560.5, 465.0 ],
                                    "source": [ "obj-5", 0 ]
                                }
                            }
                        ],
