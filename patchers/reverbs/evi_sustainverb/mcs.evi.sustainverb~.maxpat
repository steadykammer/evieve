...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dump" ],
					"patching_rect" : [ 638.5, 207.5, 45.0, 22.0 ],
					"text" : "t dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.5, 153.5, 52.0, 22.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 638.5, 99.5, 85.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.5, 398.5, 128.5, 20.0 ],
					"text" : "6 additional channels"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 139.5, 408.5, 67.0, 20.0 ],
					"text" : "2 channels"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 87.0, 355.0, 170.5, 22.0 ],
					"text" : "mc.separate~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.5, 21.0, 82.0, 20.0 ],
					"text" : "mcs version",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 100.5, 82.0, 20.0 ],
					"text" : "(just in case)"
				}
...
,
					"patching_rect" : [ 704.5, 261.5, 34.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.214285714285666, 467.5, 203.000000000000057, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.214285714285722, 467.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.5, 489.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.214285714285666, 445.5, 203.000000000000057, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.214285714285722, 445.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.5, 467.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.214285714285779, 423.5, 50.0, 20.0 ],
					"text" : "ch6: 4",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.214285714285779, 423.5, 50.0, 20.0 ],
					"text" : "ch5: 3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.214285714285666, 423.5, 50.0, 20.0 ],
					"text" : "ch4: 2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.214285714285666, 423.5, 50.0, 20.0 ],
					"text" : "ch3: 1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.5, 423.5, 66.0, 20.0 ],
					"text" : "ch2: Right",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 220.5, 423.5, 66.0, 20.0 ],
					"text" : "ch1: Left",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 445.5, 81.0, 20.0 ],
					"text" : "Left & Right",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 356.5, 18.5, 301.0, 20.0 ],
					"text" : "@ttributes or messages to evi.mcs.sustainverb~",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.5, 315.5, 188.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage evi_mcs_sustainverb",
					"varname" : "evi_mcs_sustainverb"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 638.5, 393.5, 30.0, 30.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 619.0, 174.0, 40.0, 22.0 ],
									"text" : "evi.pz"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 564.0, 213.0, 40.0, 22.0 ],
									"text" : "evi.pz"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 511.0, 252.0, 40.0, 22.0 ],
									"text" : "evi.pz"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 493.85714285714289, 384.0, 44.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 493.85714285714289, 345.0, 91.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 148.0, 180.0, 488.857142857142776, 181.0 ],
...
,
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 802.714285714285666, 250.5, 101.0, 22.0 ],
									"restore" : [ 43.0 ],
...
,
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 196.857142857142861, 213.0, 88.0, 22.0 ],
									"restore" : [ 3000.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
,
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 247.285714285714278, 174.0, 66.0, 22.0 ],
									"restore" : [ 0.2 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
,
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 98.428571428571431, 252.0, 85.0, 22.0 ],
									"restore" : [ 0.707107 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 519.35714285714289, 438.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 10,
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 49.0, 81.0, 463.85714285714289, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 772.714285714285666, 34.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 906.142857142857338, 251.5, 83.0, 20.0 ],
									"text" : "millseconds"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 695.0, 214.0, 150.0, 20.0 ],
									"text" : "% 0 .. 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 644.0, 253.0, 150.0, 20.0 ],
									"text" : "dB"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 598.0, 292.0, 150.0, 20.0 ],
									"text" : "0/1 OR % 0..1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 286.85714285714289, 214.0, 149.000000000000085, 20.0 ],
									"text" : "Hz"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 314.999999999999943, 175.0, 149.000000000000057, 20.0 ],
									"text" : "% 0..1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 185.428571428571445, 253.0, 149.000000000000057, 20.0 ],
									"text" : "% 0..1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 113.0, 292.0, 149.000000000000057, 20.0 ],
									"text" : "% 0..1 OR 0/1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 772.714285714285666, 195.5, 153.0, 20.0 ],
									"text" : "Global"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 483.714285714285666, 175.0, 153.0, 20.0 ],
									"text" : "MIX"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 772.714285714285666, 195.5, 216.000000000000114, 132.5 ],
									"proportion" : 0.39,
									"rounded" : 2
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 483.714285714285666, 174.0, 227.0, 154.0 ],
									"proportion" : 0.39,
									"rounded" : 2
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 520.5, 323.5, 256.214285714285722, 323.5 ],
									"source" : [ "obj-10", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 573.5, 328.5, 305.64285714285711, 328.5 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 628.5, 333.0, 355.071428571428555, 333.0 ],
									"source" : [ "obj-33", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 812.214285714285666, 338.5, 404.5, 338.5 ],
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 575.35714285714289, 419.0, 528.85714285714289, 419.0 ],
									"source" : [ "obj-4", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 305.642857142857224, 156.5, 520.5, 156.5 ],
									"source" : [ "obj-50", 5 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 355.071428571428612, 149.0, 573.5, 149.0 ],
									"source" : [ "obj-50", 6 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-17", 0 ],
									"midpoints" : [ 404.5, 142.5, 628.5, 142.5 ],
									"source" : [ "obj-50", 7 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 453.928571428571445, 120.25, 812.214285714285666, 120.25 ],
									"source" : [ "obj-50", 8 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 503.35714285714289, 421.5, 393.5, 421.5 ],
									"source" : [ "obj-6", 0 ]
								}
...
,
					"patching_rect" : [ 704.5, 207.5, 95.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"comment" : "(messages) controls to evi.mcs.sustainverb~",
					"id" : "obj-47",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 269.5, 40.5, 388.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 670.5, 398.5, 124.0, 20.0 ],
					"text" : "dumpout"
				}
...
, 			{
				"box" : 				{
					"comment" : "(multichannelsignal) 6 channels additional RVRB outlets",
					"id" : "obj-8",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 238.5, 393.5, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "(multichannelsignal) RVRB Out Left & Right",
					"id" : "obj-5",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.5, 393.5, 50.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 87.5, 315.5, 148.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autoexport" : 0
					}
,
					"text" : "mcs.gen~ evi_sustainverb"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-54", 0 ],
					"midpoints" : [ 353.0, 191.0, 714.0, 191.0 ],
					"source" : [ "obj-48", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.600000023841858, 0.400000035762787, 0.199999943375587, 1.0 ],
					"destination" : [ "obj-59", 0 ],
					"midpoints" : [ 269.0, 247.5, 648.0, 247.5 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-52", 0 ],
					"midpoints" : [ 790.0, 299.0, 97.0, 299.0 ],
					"source" : [ "obj-54", 1 ]
				}
