...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dump" ],
					"patching_rect" : [ 616.5, 227.0, 45.0, 22.0 ],
					"text" : "t dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 616.5, 173.0, 52.0, 22.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 616.5, 119.0, 85.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 259.0, 120.0, 81.0, 20.0 ],
					"text" : "(just in case)"
				}
...
,
					"patching_rect" : [ 801.0, 227.0, 34.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 682.5, 251.0, 193.0, 47.0 ],
					"text" : "same scripting name as [evi.sustainverb~] etc so we can easily paste-replace in parent"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.5, 417.5, 128.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.5, 427.5, 67.0, 20.0 ],
					"text" : "2 channels"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.0, 374.0, 170.5, 22.0 ],
					"text" : "mc.separate~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.5, 40.0, 82.0, 20.0 ],
					"text" : "mcs version",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.214285714285666, 486.5, 203.000000000000057, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.214285714285722, 486.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.5, 508.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.214285714285666, 464.5, 203.000000000000057, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.214285714285722, 464.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.5, 486.5, 140.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 486.214285714285779, 442.5, 50.0, 20.0 ],
					"text" : "ch6: 4",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.214285714285779, 442.5, 50.0, 20.0 ],
					"text" : "ch5: 3",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 384.214285714285666, 442.5, 50.0, 20.0 ],
					"text" : "ch4: 2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.214285714285666, 442.5, 50.0, 20.0 ],
					"text" : "ch3: 1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.5, 442.5, 66.0, 20.0 ],
					"text" : "ch2: Right",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.5, 442.5, 66.0, 20.0 ],
					"text" : "ch1: Left",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 464.5, 81.0, 20.0 ],
					"text" : "Left & Right",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.5, 62.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.5, 62.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.5, 412.5, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.5, 412.5, 50.0, 50.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 551.0, 492.5, 284.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.5, 280.5, 68.0, 22.0 ],
					"text" : "exportcode"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.714285714285722, 65.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 617.0, 334.5, 218.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage evi_mcs_sustainverb_lite",
					"varname" : "evi_mcs_sustainverb_lite"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 616.5, 412.5, 30.0, 30.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 551.0, 292.0, 149.000000000000057, 20.0 ],
									"text" : "% 0..1 OR 0/1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 197.285714285714249, 380.0, 30.0, 30.0 ]
								}
...
,
									"patching_rect" : [ 49.0, 345.0, 315.571428571428555, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 197.285714285714249, 213.0, 88.0, 22.0 ],
									"restore" : [ 3000.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
,
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 98.428571428571431, 252.0, 55.0, 22.0 ],
									"restore" : [ 0.803554 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 444.428571428571445, 380.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 9,
									"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 49.0, 81.0, 414.428571428571445, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 287.285714285714221, 214.0, 59.000000000000114, 20.0 ],
									"text" : "Hz"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 314.428571428571331, 175.0, 59.000000000000057, 20.0 ],
									"text" : "% 0..1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 155.428571428571445, 253.0, 149.000000000000057, 20.0 ],
									"text" : "% 0..1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 434.0, 174.0, 284.428571428571672, 154.0 ],
									"proportion" : 0.39,
									"rounded" : 2
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 34.0, 121.0, 330.571428571428555, 207.0 ],
									"proportion" : 0.39,
									"rounded" : 2
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 526.5, 333.0, 305.64285714285711, 333.0 ],
									"source" : [ "obj-33", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 571.5, 338.5, 355.071428571428555, 338.5 ],
									"source" : [ "obj-35", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 481.5, 327.5, 256.214285714285666, 327.5 ],
									"source" : [ "obj-4", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 305.642857142857167, 154.5, 481.5, 154.5 ],
									"source" : [ "obj-50", 5 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 355.071428571428555, 136.5, 526.5, 136.5 ],
									"source" : [ "obj-50", 6 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 157.357142857142861, 158.25, 107.928571428571431, 158.25 ],
									"source" : [ "obj-50", 2 ]
								}
...
,
					"patching_rect" : [ 682.5, 227.0, 95.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 237.5, 172.5, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.5, 62.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 185.5, 118.5, 71.0, 22.0 ],
					"text" : "route signal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 273.214285714285779, 59.5, 362.285714285714221, 35.0 ],
					"text" : "patcherargs @early 0.707107 @late 0.803554 @crossover 3000. @damp 0.1 @fdnsum 0. @drywet 0.8666 @smoothtime 22.666"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.5, 280.5, 35.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.5, 280.5, 103.0, 22.0 ],
					"text" : "r #0_toSusvL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.5, 335.5, 134.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 648.5, 417.5, 132.0, 20.0 ],
					"text" : "dumpout"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.5, 334.5, 170.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autoexport" : 0
					}
,
					"text" : "mcs.gen~ evi_sustainverb_lite"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-52", 0 ],
					"hidden" : 1,
					"midpoints" : [ 375.0, 318.0, 73.0, 318.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-52", 0 ],
					"midpoints" : [ 247.0, 318.0, 73.0, 318.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-52", 0 ],
					"hidden" : 1,
					"midpoints" : [ 98.0, 318.0, 73.0, 318.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-54", 0 ],
					"midpoints" : [ 331.0, 210.0, 692.0, 210.0 ],
					"source" : [ "obj-48", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.600000023841858, 0.400000035762787, 0.199999943375587, 1.0 ],
					"destination" : [ "obj-59", 0 ],
					"midpoints" : [ 247.0, 266.5, 626.5, 266.5 ],
					"source" : [ "obj-48", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-52", 0 ],
					"midpoints" : [ 768.0, 318.0, 73.0, 318.0 ],
					"source" : [ "obj-54", 1 ]
				}
