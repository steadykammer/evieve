...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 34.0, 331.0, 122.0, 22.0 ],
					"text" : "gen~ evi_mattaverb"
				}
...
, 			{
				"box" : 				{
					"comment" : "(signal) Audio In Right / messages to evi.mattaverb~",
					"id" : "obj-47",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "(signal) Audio In Left / messages to evi.mattaverb~",
					"id" : "obj-46",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 137.0, 223.0, 47.0, 22.0 ],
					"text" : "t signal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 34.0, 223.0, 47.0, 22.0 ],
					"text" : "t signal"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 95.5, 130.0, 198.5, 130.0 ],
					"source" : [ "obj-44", 1 ]
				}
