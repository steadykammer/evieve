        ...
        "boxes": [
            ...
            },
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 82.0, 382.0, 105.0, 20.0 ],
                                    "text": "to [thispoly~]",
                                    "textjustification": 1
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "int", "int" ],
                                    "patching_rect": [ 105.0, 139.0, 71.0, 22.0 ],
                                    "text": "maximum 1"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "int" ],
                                    "patching_rect": [ 105.0, 100.0, 30.0, 22.0 ],
                                    "text": "i 10"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 226.0, 179.0, 94.0, 20.0 ],
                                    "text": "set busy state"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "signal" ],
                                    "patching_rect": [ 188.0, 178.0, 36.0, 22.0 ],
                                    "text": ">~ 0."
                                }
                            },
                            {
                    ...
                    "patching_rect": [ 442.0, 369.0, 122.0, 22.0 ],
                    "text": "p mute_and_busy"
                }
            },
            {
                "box": {
            ...
            {
                "box": {
                    "comment": "(signal) set busy state to [thispoly~]",
                    "id": "obj-11",
                    "index": 4,
                    "maxclass": "outlet",
                    "numinlets": 1,
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 474.0, 452.0, 70.0, 33.0 ],
                    "text": "to [thispoly~]",
                    "textjustification": 1
                }
            },
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 1100.5, 358.41796875, 503.0, 358.41796875 ],
                    "source": [ "obj-49", 0 ]
                }
            },
            {
