        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 64.0, 27.0, 211.0, 20.0 ],
                    "text": "arg #1: upsampling factor (2, 4 or 8)"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numoutlets": 3,
                                    "outlettype": [ "", "int", "int" ],
                                    "patching_rect": [ 64.0, 159.0, 58.0, 22.0 ],
                                    "text": "change 4"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "bang", "int" ],
                                    "patching_rect": [ 64.0, 198.0, 30.0, 22.0 ],
                                    "text": "t b i"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 313.0, 283.0, 69.0, 22.0 ],
                                    "text": "prepend up"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 64.0, 283.0, 232.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 6,
                                    "outlettype": [ "", "", "", "", "", "" ],
                                    "patching_rect": [ 426.0, 237.0, 214.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 2,
                                    "outlettype": [ "", "" ],
                                    "patching_rect": [ 64.0, 120.0, 152.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 266.0, 34.0, 30.0, 30.0 ]
                                }
                            },
                            {
                                "box": {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 426.0, 433.0, 30.0, 30.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 621.0, 433.0, 30.0, 30.0 ]
                                }
                            }
                        ],
                        "lines": [
                    ...
                    "patching_rect": [ 64.0, 303.0, 119.0, 22.0 ],
                    "text": "p parse"
                }
            },
            {
            ...
            {
                "box": {
                    "comment": "(signal/float) Control Sweep 0..1",
                    "id": "obj-36",
                    "index": 8,
                    "maxclass": "inlet",
                    "numinlets": 0,
            ...
            {
                "box": {
                    "comment": "(signal/float) Control Scale 0..1",
                    "id": "obj-32",
                    "index": 7,
                    "maxclass": "inlet",
                    "numinlets": 0,
            ...
            {
                "box": {
                    "comment": "(signal/float) Control Offset 0..1",
                    "id": "obj-34",
                    "index": 6,
                    "maxclass": "inlet",
                    "numinlets": 0,
            ...
            {
                "box": {
                    "comment": "(signal/float) Vactrol Fall in ms",
                    "id": "obj-30",
                    "index": 5,
                    "maxclass": "inlet",
                    "numinlets": 0,
            ...
            {
                "box": {
                    "comment": "(signal/float) Vactrol Rise in ms",
                    "id": "obj-28",
                    "index": 4,
                    "maxclass": "inlet",
                    "numinlets": 0,
